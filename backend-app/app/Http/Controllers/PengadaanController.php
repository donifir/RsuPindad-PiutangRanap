...
class PengadaanController extends Controller
{
    ...
    public function pulldata(Request $request)
    {
        ...
        if ($validator->fails()) {
            ...
            $datapenerimaan =  SaldoAwalModel::where('nama_bulan',$request->nama_bulan)
            ->join('detailpesan', 'ext_saldo_awal.kode_brng', '=', 'detailpesan.kode_brng')
            ...
            $dataretur =  SaldoAwalModel::where('nama_bulan',$request->nama_bulan)
            ->join('riwayat_barang_medis as retur', 'ext_saldo_awal.kode_brng', '=', 'retur.kode_brng')
            //retur
            ->join('databarang', 'ext_saldo_awal.kode_brng', '=', 'databarang.kode_brng')
            ->join('jenis', 'databarang.kdjns', '=', 'jenis.kdjns')
            ...
            $datapengeluaran =  SaldoAwalModel::where('nama_bulan',$request->nama_bulan)
            ->join('riwayat_barang_medis as pengeluaran', 'ext_saldo_awal.kode_brng', '=', 'pengeluaran.kode_brng')
            //pengeluaran
            ->join('databarang', 'ext_saldo_awal.kode_brng', '=', 'databarang.kode_brng')
            ->join('jenis', 'databarang.kdjns', '=', 'jenis.kdjns')
